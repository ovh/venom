...
- [CLI Usage](#cli-usage)
  - [Run test suites in a specific order](#run-test-suites-in-a-specific-order)
...
* ShouldNotJSONEqual - [example](https://github.com/ovh/venom/tree/master/tests/assertions/ShouldNotJSONEqual.yml)
