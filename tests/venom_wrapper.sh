...
./venom.test -test.coverprofile=./$NANO_TIMESTAMP.coverprofile -test.run="^TestBincoverRunMain$" -args-file=./$NANO_TIMESTAMP.args.file 1> $NANO_TIMESTAMP.out 2> $NANO_TIMESTAMP.error.out
EXI=$?
